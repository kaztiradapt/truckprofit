          ...
          {routeAlternatives.length ? <div className="route-alternatives" aria-label="Варианты маршрута">
            ...
            <small>{routingProvider === "google"
              ...
              : alternativesMode === "automatic-corridors"
                ...
                : "Альтернативы рассчитаны OSRM / OpenStreetMap."} Это автомобильный маршрут: масса, высота и осевые ограничения грузовика не учитываются. Проверьте допустимость проезда; время не включает ожидание на границах.</small>
          </div> : null}
