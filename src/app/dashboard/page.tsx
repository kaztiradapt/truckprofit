      ...
      <section className="content" id="overview">
        ...
        {canOperate ? <section className="operations" id="operations">
          ...
          <div className="workbench">
            ...
            <form action={createDriver} className="flow-card"><b>2. {ownerDriver ? "Дополнительный водитель" : "Водитель"}</b><input type="hidden" name="organization_id" value={data.organization.id} /><input name="display_name" placeholder="Марат Садыков" required /><span className="flow-hint">{ownerDriver ? "Этот шаг нужен только при найме другого водителя." : "Если вы сами за рулём, включите режим владельца-водителя в карточке команды выше."}</span><button type="submit">Сохранить</button></form>
