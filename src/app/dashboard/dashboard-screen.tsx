      ...
      <section className="content">
        ...
        {section === "help" ? <section className="help-section">
          ...
          <div className="faq-list">
            ...
            <details><summary>В какой валюте водитель вводит расходы?</summary><p>Бот указывает код основной валюты компании перед вводом суммы. Если чек в другой валюте, сначала пересчитайте сумму по курсу операции в валюту компании и приложите оригинальный чек. Автоматический выбор иностранной валюты и курса в водительском диалоге пока не предусмотрен.</p></details>
