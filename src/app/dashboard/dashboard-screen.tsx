      ...
      <section className="content">
        ...
        {section === "help" ? <section className="help-section">
          ...
          <div className="faq-list">
            ...
            <details><summary>Сохраняются ли старые геопозиции водителя?</summary><p>Да. Каждая отправленная водителем точка остаётся в истории рейса вместе с его комментарием. Последняя отмечена как текущая, а прошлые можно открыть по номеру, подписать и дополнить в Mini App.</p></details>
