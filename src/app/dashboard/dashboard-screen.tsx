      ...
      <section className="content">
        ...
        {section === "help" ? <section className="help-section">
          ...
          <article className="training-video-card">
            <div className="training-video-copy"><p className="eyebrow">Видеоинструкция · 1:56</p><h3>Первый рейс: от создания до отчёта</h3><p>Автомобиль и водитель, маршрут, уведомление в Telegram, статусы, расход с чеком и итоговый отчёт — в одном коротком сценарии.</p></div>
