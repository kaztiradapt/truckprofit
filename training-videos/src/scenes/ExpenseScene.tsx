  ...
  return (
    <SceneBase scene="expense" audio="voiceover/05-expense.wav" number="04" eyebrow="Расходы" title={<>Расход и чек<br />сразу в рейсе.</>}>
      <div style={{ width: "100%", height: "100%", position: "relative" }}>
        ...
        <GuidedCursor stops={[
          { frame: 245, x: 72, y: 442, click: true, label: "Прикрепить чек" },
          { frame: 325, x: 78, y: 632, click: true, label: "Сохранить расход" },
          { frame: 430, x: 1052, y: 347, click: true, label: "Открыть чек" },
        ]} />
      </div>
    </SceneBase>
  );
