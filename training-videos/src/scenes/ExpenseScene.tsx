...
import { AppWindow, BotBubble, BotButton, PhoneFrame, Pill, SceneBase } from "../components";

export const ExpenseScene: React.FC = () => {
  const frame = useCurrentFrame();
  const saved = frame > 260;
